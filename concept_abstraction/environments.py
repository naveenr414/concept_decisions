...
def get_environment(environment_string,concept_list,seed,concept_idx=[],use_processed=False,processed_concepts=None,fast_predictor=None,intervention_prob=0.0,concept_accuracy=1.0):
    ...
    if environment_string == "cart_pole":
        ...
        def make_env():
            ...
            return env 
        vec_env = SubprocVecEnv([make_env for i in range(4)])
    ...
    if use_processed:
        ...
        vec_env = VecConceptWrapper(vec_env, None, concept_idx,intervention_prob=0.5,processed_concepts=processed_concepts,concept_accuracy=concept_accuracy)
