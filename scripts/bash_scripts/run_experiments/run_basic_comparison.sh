...
for idx in "${!SEEDS[@]}"; do
  ...
  # # --- Perfect methods ---
  for method in lp_hybrid # lp_hybrid lp_weighted # random entropy greedy perfect_concepts lp policy_selection_lp policy_selection_td
  do 
  ...
  # for method in lp_weighted # imperfect_concepts random entropy greedy  lp multiple policy_selection_lp policy_selection_td policy_selection_multiple
  # do 
