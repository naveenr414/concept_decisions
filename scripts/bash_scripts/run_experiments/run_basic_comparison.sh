...
sessions=(
  ...
  imperfect_cart_pole_pong_policy_selection_prefix
  ...
  imperfect_mini_grid_boxing_policy_selection_prefix
  imperfect_mini_grid_boxing_policy_selection_restart
  imperfect_mini_grid_boxing_policy_selection_unweighted
...
for idx in "${!SEEDS[@]}"; do
  ...
  # # # --- Perfect methods ---
  for method in policy_selection_lp policy_selection_prefix policy_selection_restart policy_selection_unweighted # perfect_concepts random entropy greedy  lp_hybrid
  do 
    for env in pong boxing # cart_pole mini_grid pong glucose boxing
    do 
  ...
  for method in policy_selection_lp policy_selection_prefix policy_selection_restart policy_selection_unweighted # ground_truth imperfect_concepts random entropy greedy lp_hybrid 
  do 
  ...
  for method in policy_selection_lp policy_selection_prefix policy_selection_restart policy_selection_unweighted # lp_hybrid # ground_truth random entropy greedy lp_hybrid # lp_hybrid lp_weighted imperfect_concepts # imperfect_concepts random entropy greedy  lp lp_old lp_hybrid multiple multiple_old policy_selection_lp policy_selection_td policy_selection_multiple
  do 
