...
for idx in "${!SEEDS[@]}"; do
  ...
  for method in  multiple_log # multiple policy_selection_lp policy_selection_prefix policy_selection_restart policy_selection_unweighted # ground_truth imperfect_concepts random entropy greedy lp_hybrid 
  do 
