...
do 
    ...
    tmux send-keys -t concepts_cub "conda activate ${environment}; python -u supervised_learning.py --seed ${seed} --num_concepts_selected ${num_concepts_selected} --out_folder cub >> ${LOGFILE} 2>&1"  ENTER 
done 
