...
if is_main:
    if is_jupyter or True: 
        # Basics 
        seed        = 42
        environment_string = "pong"
        training_timesteps = 3_000_000
        num_concepts_selected = 7
...
if is_main and run_basic:
    ...
    print("Random selection {}".format(random_selection_reward))
...
#     subset_concept, greedy_perturbed_idx = greedy_selection(perturbed_groundtruth_eval_env,concept_list,num_concepts_selected,selection_function,q_estimates_perturbed)
#     env, eval_env, additional_info = get_environment(environment_string,subset_concept,seed)
